...
urlpatterns = [
    ...
    path("designacions/run/<int:run_id>/assignments/<int:assignment_id>/explanation/", views.assignment_explanation_view, name="designacions_assignment_explanation"),
    path("designacions/run/<int:run_id>/assignments/<int:assignment_id>/manual-options/", views.manual_assignment_options_view, name="designacions_manual_assignment_options"),
    path("designacions/run/<int:run_id>/assignments/manual-suggestions-bulk/", views.manual_assignment_suggestions_bulk_view, name="designacions_manual_assignment_suggestions_bulk"),
    path("designacions/run/<int:run_id>/assignments/<int:assignment_id>/update-async/", views.update_assignment_async_view, name="designacions_update_assignment_async"),
