    ...
    def test_build_kpis_payload_preserves_legacy_sections(self):
        payload = build_kpis_payload(
            ...
            input_demand_analysis={
                "summary": {"total_equips": 1},
                "by_venue": [{"pista_joc": "Pista A", "equips": 1}],
            },
        )
        ...
        self.assertEqual(payload["input_demand_summary"], {"total_equips": 1})
        self.assertEqual(payload["input_demand_by_venue"][0]["pista_joc"], "Pista A")
