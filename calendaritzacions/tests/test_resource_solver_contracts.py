...
class ResourceSolverContractsTests(unittest.TestCase):
    def test_config_defaults_match_mvp_decisions(self):
        ...
        self.assertEqual(config.internal_solve_time_limit_seconds, 900.0)
        self.assertEqual(config.initial_solve_time_limit_seconds, 1800.0)
        self.assertEqual(config.repair_solve_time_limit_seconds, 900.0)
        self.assertEqual(config.worker_time_limit_seconds, 0.0)
        self.assertEqual(config.finalization_margin_seconds, 1800.0)
