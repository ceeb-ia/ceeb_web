...
urlpatterns = [
    ...
    path("competicio/<int:pk>/groups/preview/", competition_view(groups_preview, "inscripcions.view"), name="groups_preview"),
    path("competicio/<int:pk>/groups/create/", competition_view(groups_create, "inscripcions.edit"), name="groups_create"),
    path("competicio/<int:pk>/groups/assign/", competition_view(groups_assign, "inscripcions.edit"), name="groups_assign"),
    path("competicio/<int:pk>/groups/unassign/", competition_view(groups_unassign, "inscripcions.edit"), name="groups_unassign"),
    path("competicio/<int:pk>/groups/delete/", competition_view(groups_delete, "inscripcions.edit"), name="groups_delete"),
    path("competicio/<int:pk>/groups/delete-all/", competition_view(groups_delete_all, "inscripcions.edit"), name="groups_delete_all"),
    path("competicio/<int:pk>/groups/delete-empty/", competition_view(groups_delete_empty, "inscripcions.edit"), name="groups_delete_empty"),
    path("competicio/<int:pk>/inscripcions/groups/workspace/", competition_view(groups_workspace, "inscripcions.view"), name="groups_workspace_legacy"),
    path("competicio/<int:pk>/inscripcions/groups/detail/", competition_view(groups_detail, "inscripcions.view"), name="groups_detail_legacy"),
    path("competicio/<int:pk>/inscripcions/groups/preview/", competition_view(groups_preview, "inscripcions.view"), name="groups_preview_legacy"),
    path("competicio/<int:pk>/inscripcions/groups/create/", competition_view(groups_create, "inscripcions.edit"), name="groups_create_legacy"),
    path("competicio/<int:pk>/inscripcions/groups/assign/", competition_view(groups_assign, "inscripcions.edit"), name="groups_assign_legacy"),
    path("competicio/<int:pk>/inscripcions/groups/unassign/", competition_view(groups_unassign, "inscripcions.edit"), name="groups_unassign_legacy"),
    ...
    path("competicio/<int:pk>/inscripcions/equips/contexts/sources/save/", competition_view(equip_context_sources_save, "inscripcions.edit"), name="inscripcions_equip_context_sources_save"),
    ...
    path("competicio/<int:pk>/inscripcions/equips/delete-empty/", competition_view(equips_delete_empty, "inscripcions.edit"), name="inscripcions_equips_delete_empty"),
    ...
    path("competicio/<int:pk>/inscripcions/series-equips/preview/", competition_view(series_preview, "inscripcions.view"), name="inscripcions_series_equips_preview"),
    ...
    path("competicio/<int:pk>/inscripcions/series-equips/delete-empty/", competition_view(series_delete_empty, "inscripcions.edit"), name="inscripcions_series_equips_delete_empty"),
